"""Stack-aware `doctor` for awprism.
...
interesting failures live BETWEEN them. "awprism is installed" is not the useful
fact -- "awprism is installed and the thing it pairs with is not" is. This reports
...
SELF = 'awprism'
FAMILY = ['awask', 'awask', 'awbac', 'awbrowse', 'awdit', 'awevolve', 'awevolve', 'awfind', 'awgit', 'awgraph', 'awiam', 'awkno', 'awm', 'awmail', 'awnboard', 'awnest', 'awnet', 'awnode', 'awpredict', 'awreason', 'awrecover', 'awrecurse', 'awrelay', 'awrepl', 'awresearch', 'awrun', 'awseal', 'awshare', 'awtunnel']
PAIRS_WITH = ['awdit', 'awgraph', 'awreason', 'awrepl']
...
def _local_checks() -> "list[str]":
    ...
    from the registry, but it does not know what awprism needs at runtime, and a
